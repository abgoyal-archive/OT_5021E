...
#endif  
  /* Edge + Denoise */																
  OV7690_write_cmos_sensor(0xb7, 0x05);			/*(07-->02)modify by KeJun 20110914*/														
  OV7690_write_cmos_sensor(0xb8, 0x09);			/*(06-->0b)modify by KeJun 20110914*/														
  OV7690_write_cmos_sensor(0xb9, 0x00);			/*(00-->00)modify by KeJun 20110914*/														
  OV7690_write_cmos_sensor(0xba, 0x18);			/*(40-->18)modify by KeJun 20110914*/														
                                                        
  /* AEC/AGC target */                                  
  /*This only in fixed frame change!*/
  OV7690_write_cmos_sensor(0x24, 0x88);			/*(58-->88)modify by KeJun 20110914*/
  OV7690_write_cmos_sensor(0x25, 0x78);			/*(48-->78)modify by KeJun 20110914*/
...
static BOOL OV7690_set_param_wb(UINT16 para)
{
    ...
    { /* R gain, B gain. base: 0x40 */
     {0x60,0x3f}, /* cloud */
     {0x3a,0x40}, /* daylight */
     {0x4c,0x70}, /* INCANDESCENCE */
     {0x50,0x60}, /* FLUORESCENT */
     {0x40,0x80}, /* TUNGSTEN */
    };
